...
CLIENT_SECRETS_FILE = "gcal_credentials.json"
...
def insert_broadcast(youtube, options):
  ...
  print("Broadcast {0} with title {1} was published at {2}.".format( \
...
def insert_stream(youtube, options):
  ...
  print("Stream {0} with title {1} was inserted.".format( \
...
if __name__ == "__main__":
  ...
  argparser.add_argument("--start-time", help="Scheduled start time",
    default='2017-04-04T00:00:00.000Z')
  argparser.add_argument("--end-time", help="Scheduled end time",
    default='2017-04-04T01:00:00.000Z')
